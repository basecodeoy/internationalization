...
namespace BaseCodeOy\Internationalization\Formatters;
...
final readonly class PostalLabelFormatter
{
    ...
    {
        if (!$sender->countryCode instanceof \BaseCodeOy\Internationalization\Enums\CountryCode) {
            throw new \InvalidArgumentException('The sender country code is required');
        }

        if (!$recipient->countryCode instanceof \BaseCodeOy\Internationalization\Enums\CountryCode) {
